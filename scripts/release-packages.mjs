...
const REPOSITORY_URL = "git+https://github.com/pegma-dev/scheduler.git";
const NODE_RANGE = ">=22";
...
/** Public packages in dependency order (core before Cloudflare adapter). */
export const RELEASE_PACKAGES = [
  {
    directory: "scheduler",
    name: "@pegma/scheduler",
  },
  {
    directory: "scheduler-cloudflare",
    name: "@pegma/scheduler-cloudflare",
  },
];
